...
| 2 | 本地爬虫服务启用 | `curl http://127.0.0.1:8080/health` | 重启本地服务 |
| 3 | SSH隧道打开 | `ss -tlnp \| grep 8080` | 重建MobaXterm隧道 |
...
## 🔐 Miaoshou Cookies 更新记录（2026-04-06 新增）

| 时间 | 账号 | 文件位置 | 有效期 |
|------|------|---------|--------|
| 2026-04-06 14:26 | 13016460 | /home/ubuntu/work/config/miaoshou_cookies.json | ~206天 |

**重要规则：**
- 收到用户发送的 Cookies 数据后，**必须立即**更新文件
- 更新后**必须立即**记录到 memory 系统
- **禁止**等待或延迟处理
- **禁止**只记录不更新文件
